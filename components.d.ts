...
declare module 'vue' {
  export interface GlobalComponents {
    AnimateWrapper: typeof import('./src/components/AnimateWrapper/index.vue')['default']
    ...
    SettingMenu: typeof import('./src/components/SettingMenu/SettingMenu.vue')['default']
