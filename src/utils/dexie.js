...
const tabelStores = {
    ...
    background: "++id,filename,source,sourcePath,sourceType,order,fit,hposition,vposition,visible,state,autoPause,maskEnabled,maskFrom,maskTo,createTime,updateTime",
};
