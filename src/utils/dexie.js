...
// 数据库表结构
const tabelStores = {
    config: "++id,timeDisplay,timeFontFamily,naiveTheme,country,language,location,useFileSystem,createTime,updateTime",
    background: "++id,filename,source,sourcePath,sourceType,order,fit,hposition,vposition,viewSize,visible,rotate,state,autoPause,volume,muted,maskEnabled,maskFrom,maskTo,createTime,updateTime",
};
